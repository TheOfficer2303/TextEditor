...
from consts.Menu import FILE_MENU, EDIT_MENU, MOVE_MENU
...
def setup_move_menu(self):
  ...
  for option in MOVE_MENU:
    command = f"_{option['command']}"
    self.move_menu.add_command(label=option["label"],
